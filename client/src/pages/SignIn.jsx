      ...
      <div className="flex justify-center items-center px-6 py-12 max-w-6xl  mx-auto flex-wrap">
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          <form onSubmit={handleSubmit}>
            ...
            <button className='bg-blue-600 w-full py-2 mt-5 rounded-md font-medium uppercase hover:bg-blue-700 transition duration-200 ease-in-out text-white active:scale-[.98] hover:shadow-lg' type='submit'>Sign In</button>
